...
void CRotationDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Radio(pDX, IDC_RADIO_BILINEAR2, m_radio_interp);
	DDX_Control(pDX, IDC_EDIT_ROTATION, m_EditRotateAngle);
}


BEGIN_MESSAGE_MAP(CRotationDlg, CDialogEx)
	ON_BN_CLICKED(IDC_OKBUTTON3, &CRotationDlg::OnBnClickedOkbutton3)
	ON_CONTROL_RANGE(BN_CLICKED, IDC_RADIO_BILINEAR2, IDC_RADIO_BICUBIC2, OnRadioClicked)
END_MESSAGE_MAP()
...
void CRotationDlg::OnBnClickedOkbutton3()
{
