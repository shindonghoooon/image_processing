...
void CMeanFilterDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_CONTRA, Edit_Q);
}


BEGIN_MESSAGE_MAP(CMeanFilterDlg, CDialogEx)
	ON_BN_CLICKED(IDC_OKBUTTON6, &CMeanFilterDlg::OnBnClickedOkbutton6)
	ON_BN_CLICKED(IDC_CANCELBUTTON6, &CMeanFilterDlg::OnBnClickedCancelbutton6)
	ON_CONTROL_RANGE(BN_CLICKED, IDC_RADIO_ARITHMETIC, IDC_RADIO_CONTRAHARMONIC, OnRadioClicked)
END_MESSAGE_MAP()
...
void CMeanFilterDlg::OnBnClickedOkbutton6()
{
...
void CMeanFilterDlg::OnBnClickedCancelbutton6()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}
